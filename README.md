...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oasis-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `oasis` can be installed with:

```
conda install oasis
```

It is possible to list all of the versions of `oasis` available on your platform with:
